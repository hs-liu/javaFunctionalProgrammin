...
*/
  ...
  @Test
  public void pointAddMore() {
    assertTrue(equalPoints(new Point(0, 0).add(new Point(100, 0)), new Point(100, 0)));
  }

  @Test
  public void pointAddEmp() {
    assertTrue(equalPoints(new Point().add(new Point(1)), new Point(1, 0)));
  }

  @Test
  public void pointCreateSetY() {
    assertTrue(equalPoints(new Point().setY(5), new Point(0, 5)));
  }

  @Test
  public void pointCreateGetY() {
    assertTrue(new Point(2).setY(2).getY() == 2);
  }
  ...
  @Test
  public void rectangleIntersect1FixErr() {
    Rectangle r1 = new Rectangle(new Point(0, 100), 10, 10);
    Rectangle r2 = new Rectangle(new Point(8, 0), 10, 100);

    assertTrue(r1.intersects(r2));
  }

  @Test
  public void rectangleNew() {
    assertTrue(equalRectangles(
            new Rectangle(new Point(), new Point(0, 10)),
            new Rectangle(0, 10)));
  }

  @Test
  public void rectangleNewSet() {
    assertTrue(equalRectangles(
            new Rectangle(new Point(), new Point(0, 10)).setHeight(100),
            new Rectangle(0, 100)));
  }

  @Test
  public void rectangleNewGet() {
    assertTrue(equalPoints(
            new Rectangle(new Point(), new Point(0, 10)).setHeight(100).getBottomRight(),
            new Point(0, 100)));
  }
  ...
  public void listTranslate1() {
    assertTrue(equalRectangleLists(Arrays.asList(
                    new Rectangle(new Point(20, 110), 100, 100),
                    new Rectangle(new Point(25, 115), 100, 100)),
            ListAlgorithms.translate(Arrays.asList(
                    new Rectangle(new Point(20, 110), 100, 100),
                    new Rectangle(new Point(25, 115), 100, 100)), new Point())));
  }

  @Test
  public void listGetSumOfAreas2() {
    assertEquals(0,
            ListAlgorithms.getSumOfAreas(new ArrayList<>()));
  }

  @Test
  public void listFindMaxHeight2() {
    assertEquals(0, ListAlgorithms.findMaxHeight(new ArrayList<>()));
  }

  @Test
  public void listGetAreaMap2() {
    Map<Rectangle, Integer> result = ListAlgorithms.getAreaMap(INCREASING_ENCLOSING);
    Map<Rectangle, Integer> expected = new HashMap<>();
    assertEquals(expected.keySet().size(), 0);
  }
  ...
  @Test
  public void StreamTranslate1() {
    assertTrue(equalRectangleLists(
                    Arrays.asList(new Rectangle(new Point(20, 110), 100, 100),
                            new Rectangle(new Point(25, 115), 100, 100)
                    ),
                    StreamAlgorithms.translate(
                            Arrays.asList(new Rectangle(new Point(20, 110), 100, 100),
                                    new Rectangle(new Point(25, 115), 100, 100)
                            ).stream(), new Point()).collect(toList())
            )
    );
  }

  @Test
  public void StreamGetSumOfAreas2() {
    assertEquals(0,
            StreamAlgorithms.getSumOfAreas(Stream.empty()
            )
    );
  }

  @Test
  public void StreamFindMaxHeight2() {
    assertEquals(0, StreamAlgorithms.findMaxHeight(Stream.empty()));
  }

  @Test
  public void StreamGetAreaMap2() {
    Map<Rectangle, Integer> result = StreamAlgorithms.getAreaMap(INCREASING_ENCLOSING.stream());
    Map<Rectangle, Integer> expected = new HashMap<>();
    assertEquals(expected.keySet().size(), 0);
  }
  ...
  public void rectangleIntersection4() {
    assertFalse(
            new Rectangle(new Point(), 20, 20).intersection(
                    new Rectangle(new Point(20, 21), 15, 15)
            ).isPresent()
    );
  }
  ...
  public void streamIntersectAll3() {
    assertFalse(StreamAlgorithms.intersectAll(Stream.empty()).isPresent());
  }
}
